import { handleServiceSignstudent } from "../../service/studentService";
...
function StudentScreen() {
  ...
  const handleButtonStyle = (lastname, firstname, email, classroom) => {
    console.log(lastname + firstname + email + classroom);
  ...
  const handleLogin = () => {
    ...
    handleServiceSignstudent(userInfo).then((result) => {
      setIsLoading(false);
